...
path_orig = '/storage/homefs/st20f757/vqa/data/Tools/DME_v2'
path_output = '/storage/homefs/st20f757/vqa/locvqallm/data/dme/processed'
# create output dir
...
for subset in subsets:
    ...
    for l in tqdm(data, desc=f'Processing {subset}'):
        ...
        # get the answer
        answer = str(l['answer']) # because some answers are integers
        # get the image path
